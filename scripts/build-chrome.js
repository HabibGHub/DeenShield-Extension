...
console.log('=============================================');
console.log(' Building Deen Shield for Chrome Web Store');
console.log('=============================================');
...
const zipName = path.join(distDir, 'deen-shield-chrome-v1.1.0.zip');
try {
...
console.log('=============================================');
console.log(' Chrome Web Store Build Complete!');
console.log('=============================================');
